                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-end md:items-center gap-6">
                    ...
                    <div className="flex flex-col md:flex-row items-end md:items-center gap-4">
                        ...
                        <div className="relative group/search w-full md:w-64">
                            <div className="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl flex items-center shadow-lg transition-all focus-within:bg-white/20 focus-within:border-white/40 focus-within:shadow-xl px-2 min-h-[48px]">
                                <div className="pl-3 text-emerald-200 group-focus-within/search:text-[#D4AF37] transition-colors"><Search size={18} /></div>
                                <input 
                                    type="text" 
                                    value={searchTerm} 
                                    onChange={e => setSearchTerm(e.target.value)} 
                                    placeholder="Cari formulir..." 
                                    className="w-full bg-transparent border-none py-2.5 px-3 text-white placeholder-emerald-200/50 text-xs font-bold focus:ring-0 tracking-wide" 
                                />
                            </div>
                        </div>
